    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="/komik/update/<?= $komik['id']; ?>" method="post" enctype="multipart/form-data">
                <!-- csrf supaya form ini dapat di input lewat halaman ini saja -->
                <!-- cross side resource forgiery -->
                <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <!-- jika old judul ada isinya, jika true maka cetak old, jika false cetak isi tabelnya-->
